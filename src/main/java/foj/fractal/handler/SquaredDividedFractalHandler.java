...
import foj.fractal.engine.SquaredDividedFractalContext;
import foj.fractal.engine.SquaredDividedFractalMaster;
...
public class SquaredDividedFractalHandler extends AbstractStreamHandler {

    private final Logger log = LoggerFactory.getLogger(SquaredDividedFractalHandler.class);
    ...
    protected String process(
        ...
        try {
            final SquaredDividedFractalContext context = new SquaredDividedFractalContext(
                    getWidth(split),
                    getHeight(split));
            ...
            final SquaredDividedFractalMaster master = new SquaredDividedFractalMaster(
                    executorService,
                    context,
