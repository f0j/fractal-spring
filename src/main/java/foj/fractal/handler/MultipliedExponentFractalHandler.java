...
import foj.fractal.engine.MultipliedExponentFractalMaster;
import foj.fractal.engine.MultipliedExponentFractalContext;
...
public class MultipliedExponentFractalHandler extends AbstractStreamHandler {

    private final Logger log = LoggerFactory.getLogger(MultipliedExponentFractalHandler.class);
    ...
    protected String process(
        ...
        try {
            final MultipliedExponentFractalContext context = new MultipliedExponentFractalContext(
                    getWidth(split),
                    getHeight(split));
            ...
            final MultipliedExponentFractalMaster master = new MultipliedExponentFractalMaster(
                    executorService,
                    context,
