...
import foj.fractal.engine.MandelbrotFractalContext;
import foj.fractal.engine.MandelbrotFractalMaster;
...
public class MandelbrotFractalHandler extends AbstractStreamHandler {

    private final Logger log = LoggerFactory.getLogger(MandelbrotFractalHandler.class);
    ...
    protected String process(
        ...
        try {
            final MandelbrotFractalContext context = new MandelbrotFractalContext(
                    getWidth(split),
                    getHeight(split));
            ...
            final MandelbrotFractalMaster master = new MandelbrotFractalMaster(
                    executorService,
                    context,
