...
public class JuliaFractalWorker extends AbstractFractalWorker {
    ...
    private final JuliaFractalContext params;
    private final WorkPublisher publisher;

    public JuliaFractalWorker(
            final int[] xpxs,
            final int[] ypxs,
            final JuliaFractalContext params,
    ...
    final String calculate(
        ...
        for (; it < MAX_ITERATIONS_INT && abs <= MAX_VALUE; it++) {
            ...
            z = DoubleComplex.add(z, params.constant);
